...
import com.ggbwallet.token.util.DateTime;
import com.ggbwallet.token.util.DateTimeFactory;
        ...
        switch (getAs())
        {
            ...
            case Mapping:
                ...
                else
                {
                    ...
                    //refer to 'GgbWallet meetup indices' where 'Match' mapping is null but for FIFA is not.
