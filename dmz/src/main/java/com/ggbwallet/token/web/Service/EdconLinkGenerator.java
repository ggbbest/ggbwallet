package com.ggbwallet.token.web.Service;
...
import static com.ggbwallet.token.web.Service.SpawnableLinkGenerator.bytesFromSignature;
...
public class EdconLinkGenerator {
    ...
    public static void main(String[] args) throws SalesOrderMalformed {
        int rounds = 50;
        while(rounds > 0) {
            new com.ggbwallet.token.web.Service.EdconLinkGenerator(date, VIENNA, BLOCKCHAIN_HALL, 1);
            rounds--;
        }
    }
