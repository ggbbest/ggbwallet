package com.ggbwallet.token.web;
...
import com.ggbwallet.token.entity.MagicLinkInfo;
import com.ggbwallet.token.entity.NonFungibleToken;
import com.ggbwallet.token.entity.SalesOrderMalformed;
import com.ggbwallet.token.entity.XMLDsigVerificationResult;
...
import com.ggbwallet.token.tools.XMLDSigVerifier;
import com.ggbwallet.token.web.Ethereum.TokenscriptFunction;
import com.ggbwallet.token.web.Ethereum.TransactionHandler;
import com.ggbwallet.token.web.Service.CryptoFunctions;
import static com.ggbwallet.token.tools.Convert.getEthString;
import static com.ggbwallet.token.tools.ParseMagicLink.normal;
import static com.ggbwallet.token.web.Ethereum.TokenscriptFunction.ZERO_ADDRESS;
...
public class AppSiteController implements AttributeInterface
{
    ...
    private static final String appleAssociationConfig = "{\n" +
            ...
            "    \"details\": [\n" +
            "      {\n" +
            "        \"appID\": \"LRAW5PL536.com.stormbird.ggbwallet\",\n" +
            "        \"paths\": [ \"*\" ]\n" +
            "      }\n" +
            "    ]\n" +
            "  }\n" +
    ...
    public RedirectView home(RedirectAttributes attributes){
        return new RedirectView("https://rpc.c4ei.net");
    }
