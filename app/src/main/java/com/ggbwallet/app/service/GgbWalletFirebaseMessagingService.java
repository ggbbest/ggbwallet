...
public class GgbWalletFirebaseMessagingService
{

}
/*public class GgbWalletFirebaseMessagingService extends FirebaseMessagingService {
    public static final String TAG = GgbWalletFirebaseMessagingService.class.getSimpleName();
    public static final String IDENTITY_POOL_ID = "us-west-2:6d3c1431-0764-43f0-8ced-54e584fd01ad";
    public static final String PLATFORM_APPLICATION_ARN = "arn:aws:sns:us-west-2:400248756644:app/GCM/GgbWallet-Android";
