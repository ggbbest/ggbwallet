...
import com.ggbwallet.app.util.Hex;
import com.ggbwallet.app.util.StyledStringBuilder;
...
public class Web3Transaction implements Parcelable {
     ...
     * @param minGas
     */
    public Web3Transaction(com.ggbwallet.app.entity.Transaction tx, ActionSheetMode mode, BigInteger minGas)
    {
