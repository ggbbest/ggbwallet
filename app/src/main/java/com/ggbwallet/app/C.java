...
public abstract class C {
    ...
    public static final String DAPP_PREFIX_ALPHAWALLET = "ggbwallet";
    ...
    public static final String ALPHAWALLET_LOGO_URI = "https://ggb.best/wp-content/themes/ggbwallet/img/ggbwallet-logo.svg";
}
