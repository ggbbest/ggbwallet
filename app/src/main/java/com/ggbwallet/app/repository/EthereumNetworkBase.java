...
import com.ggbwallet.token.entity.ChainSpec;
...
import static com.ggbwallet.ethereum.EthereumNetworkBase.FANTOM_RPC_URL;
import static com.ggbwallet.ethereum.EthereumNetworkBase.FANTOM_TEST_ID;
import static com.ggbwallet.ethereum.EthereumNetworkBase.FANTOM_TEST_RPC_URL;
import static com.ggbwallet.ethereum.EthereumNetworkBase.FUJI_TEST_ID;
import static com.ggbwallet.ethereum.EthereumNetworkBase.FUJI_TEST_RPC_URL;
import static com.ggbwallet.ethereum.EthereumNetworkBase.GOERLI_ID;
import static com.ggbwallet.ethereum.EthereumNetworkBase.HECO_ID;
import static com.ggbwallet.ethereum.EthereumNetworkBase.HECO_TEST_ID;
import static com.ggbwallet.ethereum.EthereumNetworkBase.KOVAN_ID;
import static com.ggbwallet.ethereum.EthereumNetworkBase.MAINNET_ID;
import static com.ggbwallet.ethereum.EthereumNetworkBase.MATIC_ID;
import static com.ggbwallet.ethereum.EthereumNetworkBase.MATIC_TEST_ID;
import static com.ggbwallet.ethereum.EthereumNetworkBase.OPTIMISTIC_MAIN_ID;
import static com.ggbwallet.ethereum.EthereumNetworkBase.OPTIMISTIC_TEST_ID;
import static com.ggbwallet.ethereum.EthereumNetworkBase.POA_ID;
import static com.ggbwallet.ethereum.EthereumNetworkBase.RINKEBY_ID;
import static com.ggbwallet.ethereum.EthereumNetworkBase.ROPSTEN_ID;
import static com.ggbwallet.ethereum.EthereumNetworkBase.SOKOL_ID;
import static com.ggbwallet.ethereum.EthereumNetworkBase.XDAI_ID;
...
public abstract class EthereumNetworkBase implements EthereumNetworkRepositoryType
{
    ...
    private static final String DEFAULT_HOMEPAGE = "https://trade.c4ei.net";
    /* constructing URLs from BuildConfig. In the below area you will see hardcoded key like da3717...
       These hardcoded keys are fallbacks used by GgbWallet forks.
    ...
    //Note that GgbWallet now uses a double node configuration. See class AWHttpService comment 'try primary node'.
    ...
    static final Map<Integer, NetworkInfo> networkMap = new HashMap<Integer, NetworkInfo>() {
        {
            ...
            put(C4EI_MAIN_ID, new NetworkInfo(C.C4EI_MAIN_NETWORK_NAME, C.C4EI_SYMBOL,
                    C4EI_MAIN_RPC_URL,
