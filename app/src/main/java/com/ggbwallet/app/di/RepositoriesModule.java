...
import com.ggbwallet.app.repository.TransactionLocalSource;
import com.ggbwallet.app.repository.TransactionRepository;
import com.ggbwallet.app.repository.TransactionRepositoryType;
import com.ggbwallet.app.repository.TransactionsRealmCache;
import com.ggbwallet.app.repository.WalletDataRealmSource;
import com.ggbwallet.app.repository.WalletRepository;
import com.ggbwallet.app.repository.WalletRepositoryType;
import com.ggbwallet.app.service.AccountKeystoreService;
import com.ggbwallet.app.service.GgbWalletService;
import com.ggbwallet.app.service.AnalyticsService;
...
import com.ggbwallet.app.service.KeystoreAccountService;
import com.ggbwallet.app.service.MarketQueueService;
import com.ggbwallet.app.service.NotificationService;
import com.ggbwallet.app.service.OpenseaService;
...
import com.ggbwallet.app.service.TransactionsNetworkClient;
import com.ggbwallet.app.service.TransactionsNetworkClientType;
...
public class RepositoriesModule {
	...
	@Singleton
	@Provides
    GgbWalletService provideFeemasterService(OkHttpClient okHttpClient,
                                               TransactionRepositoryType transactionRepository,
                                               Gson gson) {
		return new GgbWalletService(okHttpClient, transactionRepository, gson);
	}
    ...
    AssetDefinitionService provideAssetDefinitionService(OkHttpClient okHttpClient, Context ctx, NotificationService notificationService, RealmManager realmManager,
														 ...
														 TokenLocalSource tls, TransactionRepositoryType trt, GgbWalletService alphaService) {
