package com.ggbwallet.app.entity.tokenscript;
...
import com.ggbwallet.token.entity.As;
        ...
        try
        {
            ...
            switch (attr.as)
            {
                ...
                case Bytes:
                    ...
                    {
                        convertedValue = com.ggbwallet.token.tools.Numeric.toHexString(inputBytes);
                    }
                    break;
                case e18:
