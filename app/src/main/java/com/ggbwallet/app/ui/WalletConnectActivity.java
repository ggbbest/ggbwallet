...
import com.ggbwallet.app.entity.walletconnect.WCRequest;
import com.ggbwallet.app.repository.SignRecord;
import com.ggbwallet.app.ui.widget.entity.ActionSheetCallback;
import com.ggbwallet.app.viewmodel.WalletConnectViewModel;
import com.ggbwallet.app.viewmodel.WalletConnectViewModelFactory;
import com.ggbwallet.app.walletconnect.WCClient;
import com.ggbwallet.app.walletconnect.WCSession;
import com.ggbwallet.app.walletconnect.entity.WCEthereumSignMessage;
import com.ggbwallet.app.walletconnect.entity.WCEthereumTransaction;
import com.ggbwallet.app.walletconnect.entity.WCPeerMeta;
...
import static com.ggbwallet.app.C.DEFAULT_GAS_LIMIT_FOR_NONFUNGIBLE_TOKENS;
    ...
    private ActionSheetDialog generateTransactionRequest(Web3Transaction w3Tx, int chainId)
    {
        ...
        try
        {
                    ...
                    || (!w3Tx.recipient.equals(Address.EMPTY) && (w3Tx.payload != null || w3Tx.value != null))) // Raw or Function TX
            {
                ...
                viewModel.calculateGasEstimate(viewModel.getWallet(), com.ggbwallet.token.tools.Numeric.hexStringToByteArray(w3Tx.payload),
