...
import com.ggbwallet.app.entity.HomeCommsInterface;
import com.ggbwallet.app.entity.HomeReceiver;
...
import com.ggbwallet.app.ui.widget.entity.ScrollControlViewPager;
import com.ggbwallet.app.util.LocaleUtils;
import com.ggbwallet.app.util.RootUtil;
import com.ggbwallet.app.util.Utils;
import com.ggbwallet.app.viewmodel.BaseNavigationActivity;
...
import static com.ggbwallet.app.C.CHANGED_LOCALE;
import static com.ggbwallet.app.entity.WalletPage.ACTIVITY;
import static com.ggbwallet.app.entity.WalletPage.DAPP_BROWSER;
import static com.ggbwallet.app.entity.WalletPage.SETTINGS;
import static com.ggbwallet.app.entity.WalletPage.WALLET;
        ...
        FragmentMessenger, Runnable, SignAuthenticationCallback, LifecycleObserver
{
    ...
    {
        Log.d("LIFE", "GgbWallet into foreground");
    ...
    {
        Log.d("LIFE", "GgbWallet into background");
