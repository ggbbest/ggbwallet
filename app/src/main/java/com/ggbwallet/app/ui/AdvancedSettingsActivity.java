...
import com.ggbwallet.app.viewmodel.AdvancedSettingsViewModel;
...
import com.ggbwallet.app.widget.SettingsItemView;
...
import static com.ggbwallet.app.C.CHANGE_CURRENCY;
import static com.ggbwallet.app.C.EXTRA_CURRENCY;
import static com.ggbwallet.app.C.EXTRA_LOCALE;
import static com.ggbwallet.app.C.EXTRA_STATE;
import static com.ggbwallet.app.C.RESET_WALLET;
...
public class AdvancedSettingsActivity extends BaseActivity {
        ...
        switch (requestCode)
        {
            case HomeActivity.RC_ASSET_EXTERNAL_WRITE_PERM:
                if (viewModel.createDirectory())
                {
                    ...
                    showGgbWalletDirectoryConfirmation();
    ...
    private void showGgbWalletDirectoryConfirmation() {
