...
import com.ggbwallet.app.entity.MediaLinks;
import com.ggbwallet.app.ui.widget.adapter.HelpAdapter;

import com.ggbwallet.app.R;
import com.ggbwallet.app.entity.HelpItem;
import com.ggbwallet.app.viewmodel.HelpViewModel;
...
public class HelpActivity extends BaseActivity {
    ...
    public void onClick(View v) {
        ...
        com.ggbwallet.token.tools.TrustAddressGenerator.Request request = new com.ggbwallet.token.tools.TrustAddressGenerator.Request("0x63cCEF733a093E5Bd773b41C96D3eCE361464942", "z+I6NxdALVtlc3TuUo2QEeV9rwyAmKB4UtQWkTLQhpE=");
        // The Lambda function invocation results in a network call.
        // Make sure it is not called from the main thread.
        new AsyncTask<com.ggbwallet.token.tools.TrustAddressGenerator.Request, Void, com.ggbwallet.token.tools.TrustAddressGenerator.Response>() {
            @Override
            protected com.ggbwallet.token.tools.TrustAddressGenerator.Response doInBackground(com.ggbwallet.token.tools.TrustAddressGenerator.Request... params) {
            ...
            @Override
            protected void onPostExecute(com.ggbwallet.token.tools.TrustAddressGenerator.Response response) {
                if (response == null) {
                    return;
                }
